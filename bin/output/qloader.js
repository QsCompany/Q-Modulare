...
(function (System) {
    ...
    (function (net) {
        ...
        var downloadCallback = /** @class */ (function () {
    ...
    (function (core) {
        ...
        var SecureValue = /** @class */ (function () {
        ...
        var Context = /** @class */ (function () {
            ...
            Context.prototype.HandleExecution = function () {
                var config = _store[this['Id']];
                config.Module._executedHandled = true;
            };
            Context.prototype.ExecuteModule = function (success) {
                var config = _store[this['Id']];
        ...
        var Module = /** @class */ (function () {
            ...
            Module.__require = function (m, d) {
                ...
                return { mdl: mdl, isOptional: isOptional };
            };
            Module.id = 0;
            return Module;
        }());
        ...
        var Folder = /** @class */ (function () {
            ...
            Folder.prototype.GetModule = function (url) {
                ...
                if (url.IsPlugin && url.PluginName.toLowerCase() === "plugin") {
                    return moduleDownloader.get(url.moduleName);
                }
                if (url.IsFolder)
        ...
        var Assembly = /** @class */ (function (_super) {
            ...
            function Assembly(alias, url) {
                var _this_1 = _super.call(this, Folder.Me, alias) || this;
                _this_1.Assemblies = new Assemblies();
                _this_1._stat = 0;
                _this_1.pendingAssemblies = 0;
                _this_1.pending = 0;
                _this_1.NModulesFail = 0;
                _this_1.modules = [];
                _this_1._onExecuted = [];
                _this_1.modulePrototypes = [];
                _this_1.onModuleExecuted = _this_1.onModuleExecuted.bind(_this_1);
                _this_1.OnAssemblyDependencyExecuted = _this_1.OnAssemblyDependencyExecuted.bind(_this_1);
                if (!url.IsFolder)
                    throw "Invalid assembly Path";
                _this_1.resourceUrl = url;
                return _this_1;
            }
        ...
        var ModuleDownoader = /** @class */ (function () {
        ...
        (function (managers) {
            ...
            var CodeManager = /** @class */ (function (_super) {
                __extends(CodeManager, _super);
                function CodeManager() {
                    var _this_1 = _super.call(this) || this;
                    _this_1.moduleType = ModuleType.code;
                    if (CodeManager.instance)
                        throw "this is Singliton class";
                    CodeManager.instance = _this_1;
                    return _this_1;
                }
                ...
                CodeManager.loadDependencies = function (m, dependencies, callback) {
                    ...
                    for (var i = 0, l = dependencies.length; i < l; i++) {
                        var d = dependencies[i];
                        //var isOptional = false;
                        var _a = Module.__require(m, d), mdl = _a.mdl, isOptional = _a.isOptional; // CodeManager.__require(m, d)
                        // switch (d) {
                        //     case 'exports':
                        //         mdl = m.exports;
                        //         break;
                ...
                CodeManager.__require = function (m, d) {
                    var mdl;
                    var isOptional = false;
                    switch (d) {
                        case 'exports':
            ...
            var StyleManager = /** @class */ (function (_super) {
                ...
                function StyleManager() {
                    ...
                    _this_1.moduleType = ModuleType.style;
                    return _this_1;
                }
            ...
            var TemplateManager = /** @class */ (function (_super) {
                __extends(TemplateManager, _super);
                function TemplateManager() {
                    var _this_1 = _super !== null && _super.apply(this, arguments) || this;
                    _this_1.moduleType = ModuleType.template;
                    _this_1.templates = [];
                    _this_1.OnNewTemplateExecuted = new net.EventListener(managers);
                    return _this_1;
                }
            ...
            var JsonManager = /** @class */ (function (_super) {
                __extends(JsonManager, _super);
                function JsonManager() {
                    var _this_1 = _super !== null && _super.apply(this, arguments) || this;
                    _this_1.moduleType = ModuleType.json;
                    return _this_1;
                }
